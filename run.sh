...
models=( MewFuseGraph_fuse_method_GCN_missLabel_labelPropFalse_fusionOnlyOnNull 
         MewFuseGraph_fuse_method_SAGE_missLabel_labelPropFalse_fusionOnlyOnNull
         MewFuseGraph_fuse_method_GAT_missLabel_labelPropFalse_fusionOnlyOnNull)
...
# CUDA_VISIBLE_DEVICES=6 python run_wandb.py --wandb sweep --config ./configs/GNN_wandb.yaml --project_name MewFuseGraph &
