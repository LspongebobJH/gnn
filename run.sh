...
CUDA_VISIBLE_DEVICES=6 python run_wandb.py --wandb normal --config ./configs/GAT_best.yaml --project_name exp_1 --seed 0 &
CUDA_VISIBLE_DEVICES=7 python run_wandb.py --wandb normal --config ./configs/GAT_best.yaml --project_name exp_1 --seed 1 &
wait
CUDA_VISIBLE_DEVICES=6 python run_wandb.py --wandb normal --config ./configs/GAT_best.yaml --project_name exp_1 --seed 2 &
CUDA_VISIBLE_DEVICES=7 python run_wandb.py --wandb normal --config ./configs/GAT_best.yaml --project_name exp_1 --seed 3 &
wait
CUDA_VISIBLE_DEVICES=6 python run_wandb.py --wandb normal --config ./configs/GAT_best.yaml --project_name exp_1 --seed 4 &
