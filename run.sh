...
models=( MewFuseGraph_fuse_method_GCN MewFuseGraph_fuse_method_SAGE MewFuseGraph_fuse_method_GAT)
...
# CUDA_VISIBLE_DEVICES=7 python run_wandb.py --wandb sweep --config ./configs/GNN_wandb.yaml --project_name MewFuseGraph &
